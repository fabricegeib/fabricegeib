...
```PS C:\Users\Fabri> choco install opera
Chocolatey v0.11.3
Installing the following packages:
opera
By installing, you accept licenses for the packages.
Progress: Downloading Opera 85.0.4341.18... 100%

Opera v85.0.4341.18 [Approved]
opera package files install completed. Performing other installation steps.
The package Opera wants to run 'chocolateyInstall.ps1'.
...
```
PS C:\Users\Fabri> choco list -lo
Chocolatey v0.11.3
chocolatey 0.11.3
...
visualstudio2019buildtools 16.11.7.0
